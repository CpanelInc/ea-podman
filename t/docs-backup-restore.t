...
my @anchors = (
    ...
    [ 'SOURCES/util.pm',      qr{`tar czf \$tarball_name .*2> /dev/null`}, 'the shell tar czf with stderr discarded and status unchecked' ],
    [ 'SOURCES/util.pm',      qr{`tar xf \$backup_tarball 2> /dev/null`},  'the shell tar xf with stderr discarded and status unchecked' ],
